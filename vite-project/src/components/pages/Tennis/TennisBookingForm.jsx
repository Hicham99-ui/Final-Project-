...
import { FaCalendarAlt,  FaUser, FaPhone, FaCity, FaEnvelope, FaArrowLeft} from 'react-icons/fa';
import DatePicker from 'react-datepicker';
import 'react-datepicker/dist/react-datepicker.css';

const TennisBookingForm = () => {
  const { id } = useParams();
        ...
        <div className="form-section">
          ...
          {formData.time && (
            <div className="players-selection">
              ...
              <select name="players" value={formData.players} onChange={handleInputChange} required>
...
export default TennisBookingForm;